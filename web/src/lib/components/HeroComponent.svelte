<div class="hero aspect-video h-fit flex flex-row">
	<div class="hero-content text-neutral-content">
		<div class="w-full flex flex-col gap-2 sm:gap-5">
			<p class="text-xl sm:text-2xl text-primary">Hi my name is</p>
			<h1 class="mb-5 text-5xl sm:text-8xl font-semibold">Ian Marquez.</h1>
			<p
				class="relative w-[max-content]
          before:absolute before:inset-0 before:animate-typewriter before:bg-base-100
          after:absolute after:inset-0 after:w-[0.125em] after:animate-caret
          after:bg-primary text-5xl sm:text-8xl text-secondary"
			>
			...
			>
				<a href="mailto:regilmarquez123@gmail.com" target="_blank" class="link">
					<iconify-icon icon="bi:envelope" />
					regilmarquez123@gmail.com
				</a>
				<a href="https://www.linkedin.com/in/ian-marquez-99930780/" target="_blank" class="link">
					<iconify-icon icon="bi:linkedin" />
					ian-marquez-99930780
				</a>
				<a href="https://github.com/ianmarquez" target="_blank" class="link">
